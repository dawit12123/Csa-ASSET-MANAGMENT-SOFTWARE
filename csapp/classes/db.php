...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "csaasset_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "app_logs", "varname" => "csaasset_at_localhost__app_logs", "altvarname" => "app_logs", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "asset", "varname" => "csaasset_at_localhost__asset", "altvarname" => "asset", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "assetcategory", "varname" => "csaasset_at_localhost__assetcategory", "altvarname" => "assetcategory", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "assetstatus", "varname" => "csaasset_at_localhost__assetstatus", "altvarname" => "assetstatus", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "assetsuppliers", "varname" => "csaasset_at_localhost__assetsuppliers", "altvarname" => "assetsuppliers", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "assettype", "varname" => "csaasset_at_localhost__assettype", "altvarname" => "assettype", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "checkapproval", "varname" => "csaasset_at_localhost__checkapproval", "altvarname" => "checkapproval", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "csa1_uggroups", "varname" => "csaasset_at_localhost__csa1_uggroups", "altvarname" => "csa1_uggroups", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "csa_audit", "varname" => "csaasset_at_localhost__csa_audit", "altvarname" => "csa_audit", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "csa_locking", "varname" => "csaasset_at_localhost__csa_locking", "altvarname" => "csa_locking", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "csa_settings", "varname" => "csaasset_at_localhost__csa_settings", "altvarname" => "csa_settings", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "csa_uggroups", "varname" => "csaasset_at_localhost__csa_uggroups", "altvarname" => "csa_uggroups", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "csa_users", "varname" => "csaasset_at_localhost__csa_users", "altvarname" => "csa_users", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "departments", "varname" => "csaasset_at_localhost__departments", "altvarname" => "departments", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "eaempassets", "varname" => "csaasset_at_localhost__eaempassets", "altvarname" => "eaempassets", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "employee", "varname" => "csaasset_at_localhost__employee", "altvarname" => "employee", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "jobhistory", "varname" => "csaasset_at_localhost__jobhistory", "altvarname" => "jobhistory", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "jobs", "varname" => "csaasset_at_localhost__jobs", "altvarname" => "jobs", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "mode22", "varname" => "csaasset_at_localhost__mode22", "altvarname" => "mode22", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "model19fromemployee", "varname" => "csaasset_at_localhost__model19fromemployee", "altvarname" => "model19fromemployee", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "model19frompurchase", "varname" => "csaasset_at_localhost__model19frompurchase", "altvarname" => "model19frompurchase", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "model20", "varname" => "csaasset_at_localhost__model20", "altvarname" => "model20", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "price", "varname" => "csaasset_at_localhost__price", "altvarname" => "price", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "request_info", "varname" => "csaasset_at_localhost__request_info", "altvarname" => "request_info", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "sourceinfo", "varname" => "csaasset_at_localhost__sourceinfo", "altvarname" => "sourceinfo", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
			$dalTables[$conn->connId][] = array("name" => "workunit", "varname" => "csaasset_at_localhost__workunit", "altvarname" => "workunit", "connId" => "csaasset_at_localhost", "schema" => "", "connName" => "csaasset at localhost");
		}
	}
