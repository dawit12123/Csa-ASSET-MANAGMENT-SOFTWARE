...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("asset" == $this->chrt_array['tables'][0])
			return true;
		if("assetcategory" == $this->chrt_array['tables'][0])
			return true;
		if("assetsuppliers" == $this->chrt_array['tables'][0])
			return true;
		if("csa1_uggroups" == $this->chrt_array['tables'][0])
			return true;
		if("csa_audit" == $this->chrt_array['tables'][0])
			return true;
		if("csa_locking" == $this->chrt_array['tables'][0])
			return true;
		if("csa_settings" == $this->chrt_array['tables'][0])
			return true;
		if("csa_uggroups" == $this->chrt_array['tables'][0])
			return true;
		if("csa_users" == $this->chrt_array['tables'][0])
			return true;
		if("departments" == $this->chrt_array['tables'][0])
			return true;
		if("eaempassets" == $this->chrt_array['tables'][0])
			return true;
		if("jobhistory" == $this->chrt_array['tables'][0])
			return true;
		if("jobs" == $this->chrt_array['tables'][0])
			return true;
		if("model19fromemployee" == $this->chrt_array['tables'][0])
			return true;
		if("model19frompurchase" == $this->chrt_array['tables'][0])
			return true;
		if("model20" == $this->chrt_array['tables'][0])
			return true;
		if("price" == $this->chrt_array['tables'][0])
			return true;
		if("request_info" == $this->chrt_array['tables'][0])
			return true;
		if("sourceinfo" == $this->chrt_array['tables'][0])
			return true;
		if("workunit" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("employee" == $this->chrt_array['tables'][0])
			return true;
		if("app_logs" == $this->chrt_array['tables'][0])
			return true;
		if("mode22" == $this->chrt_array['tables'][0])
			return true;
		if("checkapproval" == $this->chrt_array['tables'][0])
			return true;
		if("assettype" == $this->chrt_array['tables'][0])
			return true;
		if("asset" == $this->chrt_array['tables'][0])
			return true;
		return false;
