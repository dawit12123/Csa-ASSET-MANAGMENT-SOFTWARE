...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	{
		return new ProjectSettings("csa_users", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "asset" ] = array( "url" => "asset", "type" => 0 );
	$projectEntitiesReverse[ "asset" ] = "asset";
	$projectEntities[ "assetcategory" ] = array( "url" => "assetcategory", "type" => 0 );
	$projectEntitiesReverse[ "assetcategory" ] = "assetcategory";
	$projectEntities[ "assetsuppliers" ] = array( "url" => "assetsuppliers", "type" => 0 );
	$projectEntitiesReverse[ "assetsuppliers" ] = "assetsuppliers";
	$projectEntities[ "csa1_uggroups" ] = array( "url" => "csa1_uggroups", "type" => 0 );
	$projectEntitiesReverse[ "csa1_uggroups" ] = "csa1_uggroups";
	$projectEntities[ "csa_audit" ] = array( "url" => "csa_audit", "type" => 0 );
	$projectEntitiesReverse[ "csa_audit" ] = "csa_audit";
	$projectEntities[ "csa_locking" ] = array( "url" => "csa_locking", "type" => 0 );
	$projectEntitiesReverse[ "csa_locking" ] = "csa_locking";
	$projectEntities[ "csa_settings" ] = array( "url" => "csa_settings", "type" => 0 );
	$projectEntitiesReverse[ "csa_settings" ] = "csa_settings";
	$projectEntities[ "csa_uggroups" ] = array( "url" => "csa_uggroups", "type" => 0 );
	$projectEntitiesReverse[ "csa_uggroups" ] = "csa_uggroups";
	$projectEntities[ "csa_users" ] = array( "url" => "csa_users", "type" => 0 );
	$projectEntitiesReverse[ "csa_users" ] = "csa_users";
	$projectEntities[ "departments" ] = array( "url" => "departments", "type" => 0 );
	$projectEntitiesReverse[ "departments" ] = "departments";
	$projectEntities[ "eaempassets" ] = array( "url" => "eaempassets", "type" => 0 );
	$projectEntitiesReverse[ "eaempassets" ] = "eaempassets";
	$projectEntities[ "jobhistory" ] = array( "url" => "jobhistory", "type" => 0 );
	$projectEntitiesReverse[ "jobhistory" ] = "jobhistory";
	$projectEntities[ "jobs" ] = array( "url" => "jobs", "type" => 0 );
	$projectEntitiesReverse[ "jobs" ] = "jobs";
	$projectEntities[ "model19fromemployee" ] = array( "url" => "model19fromemployee", "type" => 0 );
	$projectEntitiesReverse[ "model19fromemployee" ] = "model19fromemployee";
	$projectEntities[ "model19frompurchase" ] = array( "url" => "model19frompurchase", "type" => 0 );
	$projectEntitiesReverse[ "model19frompurchase" ] = "model19frompurchase";
	$projectEntities[ "model20" ] = array( "url" => "model20", "type" => 0 );
	$projectEntitiesReverse[ "model20" ] = "model20";
	$projectEntities[ "price" ] = array( "url" => "price", "type" => 0 );
	$projectEntitiesReverse[ "price" ] = "price";
	$projectEntities[ "request_info" ] = array( "url" => "request_info", "type" => 0 );
	$projectEntitiesReverse[ "request_info" ] = "request_info";
	$projectEntities[ "sourceinfo" ] = array( "url" => "sourceinfo", "type" => 0 );
	$projectEntitiesReverse[ "sourceinfo" ] = "sourceinfo";
	$projectEntities[ "workunit" ] = array( "url" => "workunit", "type" => 0 );
	$projectEntitiesReverse[ "workunit" ] = "workunit";
	...
	$projectEntities[ "app_logs" ] = array( "url" => "app_logs", "type" => 0 );
	$projectEntitiesReverse[ "app_logs" ] = "app_logs";
	$projectEntities[ "mode22" ] = array( "url" => "mode22", "type" => 0 );
	$projectEntitiesReverse[ "mode22" ] = "mode22";
	$projectEntities[ "checkapproval" ] = array( "url" => "checkapproval", "type" => 0 );
	$projectEntitiesReverse[ "checkapproval" ] = "checkapproval";
	$projectEntities[ "assettype" ] = array( "url" => "assettype", "type" => 0 );
	$projectEntitiesReverse[ "assettype" ] = "assettype";
	$projectEntities[ "asset in store" ] = array( "url" => "asset_in_store", "type" => 1 );
	$projectEntitiesReverse[ "asset_in_store" ] = "asset in store";
}
