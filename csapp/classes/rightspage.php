...
class RightsPage extends ListPage
{
	...
	function fillGroupsArr()
	{
		...
		$sql = "select ". 
			...
			$grConnection->addFieldWrappers( "" ) 
			." from ". 
			$grConnection->addTableWrappers( "csa1_uggroups" ) .
	...
	function getRights()
	{
		...
		$sql = "select ". $this->connection->addFieldWrappers( "" )
			...
			.", ". $this->connection->addFieldWrappers( "" )
			.", ". $this->connection->addFieldWrappers( "" )
			." from ". $this->connection->addTableWrappers( "csa1_ugrights" )
	...
	function updateTablePermissions( $table, $group, $tableRights )
	{
		...
		$rightWTableName = $this->connection->addTableWrappers( "csa1_ugrights" );
