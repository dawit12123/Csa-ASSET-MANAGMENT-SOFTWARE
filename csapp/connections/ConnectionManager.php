...
class ConnectionManager
{
	...
	{
		return $this->byId( "csaasset_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "csaasset_at_localhost";
		$data["connName"] = "csaasset at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;csaasset;;1"; //currently unused

		$this->_connectionsIdByName["csaasset at localhost"] = "csaasset_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "csaasset";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=csaasset;OPTION=3";
		// encription set
		$data["EncryptInfo"] = array();
		$data["EncryptInfo"]["mode"] = 1;
		$data["EncryptInfo"]["alg"]  = 128;
		$data["EncryptInfo"]["key"]  = "0ac98c3acc0a4ac989511fd42c83e573";

		$connectionsData["csaasset_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["asset"] = "csaasset_at_localhost";
		$connectionsIds["assetcategory"] = "csaasset_at_localhost";
		$connectionsIds["assetsuppliers"] = "csaasset_at_localhost";
		$connectionsIds["csa1_uggroups"] = "csaasset_at_localhost";
		$connectionsIds["csa_audit"] = "csaasset_at_localhost";
		$connectionsIds["csa_locking"] = "csaasset_at_localhost";
		$connectionsIds["csa_settings"] = "csaasset_at_localhost";
		$connectionsIds["csa_uggroups"] = "csaasset_at_localhost";
		$connectionsIds["csa_users"] = "csaasset_at_localhost";
		$connectionsIds["departments"] = "csaasset_at_localhost";
		$connectionsIds["eaempassets"] = "csaasset_at_localhost";
		$connectionsIds["jobhistory"] = "csaasset_at_localhost";
		$connectionsIds["jobs"] = "csaasset_at_localhost";
		$connectionsIds["model19fromemployee"] = "csaasset_at_localhost";
		$connectionsIds["model19frompurchase"] = "csaasset_at_localhost";
		$connectionsIds["model20"] = "csaasset_at_localhost";
		$connectionsIds["price"] = "csaasset_at_localhost";
		$connectionsIds["request_info"] = "csaasset_at_localhost";
		$connectionsIds["sourceinfo"] = "csaasset_at_localhost";
		$connectionsIds["workunit"] = "csaasset_at_localhost";
		$connectionsIds["employee"] = "csaasset_at_localhost";
		$connectionsIds["app_logs"] = "csaasset_at_localhost";
		$connectionsIds["mode22"] = "csaasset_at_localhost";
		$connectionsIds["checkapproval"] = "csaasset_at_localhost";
		$connectionsIds["assettype"] = "csaasset_at_localhost";
		$connectionsIds["asset in store"] = "csaasset_at_localhost";
