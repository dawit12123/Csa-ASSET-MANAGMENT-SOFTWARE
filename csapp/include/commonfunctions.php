...
function checkTableName($shortTName, $type=false)
{
	...
	if ("asset" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("assetcategory" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("assetsuppliers" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("csa1_uggroups" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("csa_audit" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("csa_locking" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("csa_settings" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("csa_uggroups" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("csa_users" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("departments" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("eaempassets" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("jobhistory" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("jobs" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("model19fromemployee" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("model19frompurchase" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("model20" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("price" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("request_info" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("sourceinfo" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("workunit" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("dashboard" == $shortTName && ($type===false || ($type!==false && $type == 4)))
		return true;
	if ("employee" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("app_logs" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("mode22" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("checkapproval" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("assettype" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("asset_in_store" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("asset");
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("assetcategory");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("assetsuppliers");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("csa1_uggroups");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("csa_audit");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("csa_locking");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("csa_settings");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("csa_uggroups");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("csa_users");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("eaempassets");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("jobhistory");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("model19fromemployee");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="model19fromemployee";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("model19frompurchase");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="model19frompurchase";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("model20");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("price");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("request_info");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("sourceinfo");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("workunit");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("app_logs");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("mode22");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("checkapproval");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("assettype");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("asset in store");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
...
function ReadUserPermissions($userID = "")
{
	...
	if($userID != "Guest")
	{
		...
		$sql = "select ".$gConn->addFieldWrappers( "" )
			...
			." from ". $gConn->addTableWrappers( "csa1_ugmembers" )
	...
	$sql = "select ". $gConn->addFieldWrappers( "" )
		.", ". $gConn->addFieldWrappers( "" )
		.", ". $gConn->addFieldWrappers( "" )
		." from ". $gConn->addTableWrappers( "csa1_ugrights" )
...
function SetAuthSessionData($pUsername, &$data, $password, &$pageObject = null, $fireEvents = true )
{
	...
	$_SESSION["_csa_users_OwnerID"] = $data["ID"];
		$_SESSION["_eaempassets_OwnerID"] = $data["ID"];
		$_SESSION["_model20_OwnerID"] = $data["active"];
		$_SESSION["_employee_OwnerID"] = $data["groupid"];
